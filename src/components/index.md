...
export default () => {
  return (
    <HeaderSearch
      ...
      defaultValue="umi ui"
      options={[
        { label: 'Rain Ink API 接口开放平台', value: 'Rain Ink API 接口开放平台' },
        {
          label: 'Rain Ink API 接口开放平台',
          value: 'Rain Ink API 接口开放平台',
        },
        {
          label: 'Pro Table',
          value: 'Pro Table',
...
<Space>
  <HeaderSearch
    ...
    options={[
      ...
      {
        label: <a href="next.ant.design">Rain Ink API 接口开放平台</a>,
        value: 'Rain Ink API 接口开放平台',
      },
      {
